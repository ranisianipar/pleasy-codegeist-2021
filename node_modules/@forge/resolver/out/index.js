...
const defaultFunctions = {
    __request: async (request) => {
        ...
        const response = await productApis[payload.product](api_1.assumeTrustedRoute(payload.fetchUrl), payload.fetchOptions);
